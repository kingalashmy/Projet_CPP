...
// Première partie d'interface qui a le bouton pour retourner à la page precedente et qui indique le niveau de difficulté choisi
    ...
    QLabel *description = new QLabel("EASY MODE");
...
// Deuxième partie d'interface qui est la partie de Joueur Ordinateur
  ...
  // Quatrième partie d'interface qui est la partie de Joueur Normal
    ...
    connect(deckButton, &QPushButton::clicked, this, &Gamepage::onDeckButtonClicked);
    ...
    connect(this, &Gamepage::checkGameEndSignal, this, &Gamepage::checkGameEnd);

    connect(back_button, &QPushButton::clicked, this, &Gamepage::onBackButtonClicked);
...
void Gamepage::onDeckButtonClicked()
{
    ...
    for (int i = 0; i < 3; ++i)
    {
        QTimer::singleShot(currentDelay, [this, i]() {
            ...
            {
            case 0:
                updateCardButton(card_11, highestCard);
                break;
            case 1:
                updateCardButton(card_22, highestCard);
                break;
            case 2:
                updateCardButton(card_33, highestCard);
                break;
            }
        });
    ...
    for (int i = 3; i < numCardsToDeal; ++i)
    {
        QTimer::singleShot(currentDelay, [this, i]() {
...
void Gamepage::updateCardButton(QPushButton *button, const Card &card)
{
...
void Gamepage::updatePlayerButton(QPushButton *cardButton)
{
...
int Gamepage::getCardValue(QPushButton *cardButton)
{
...
Card Gamepage::getCardFromButton(QPushButton *cardButton)
{
    ...
    if (hasBackgroundImage && !hasBackgroundColor)
    {
        ...
        if (compCardButton)
        {
            QTimer::singleShot(800, [this, compCardButton, compCardImageStyle]() {
                ...
                if (playerButton->styleSheet().contains("background-image"))
                {
...
void Gamepage::compareCardsAndScore()
{
